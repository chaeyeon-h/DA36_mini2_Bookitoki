...
book_filter_df=pd.read_csv('https://drive.google.com/uc?id=1gbDsd5R4bkiEVg-71SuCOGOTCbPpmoTS')
...
ages_similarity_df=pd.read_csv("https://drive.google.com/uc?id=1xfRONp2R-bKVuX1Fe5744rNsl7qEALmK",index_col='book_title')
#--------------------------------------------------------------------------------------------------------#
# # user의 top category 추천
top_book_by_category=pd.read_csv("https://drive.google.com/uc?id=1fBvbmbe78zAfMVthcmw8T_ISaxejl31y",index_col=0)
#--------------------------------------------------------------------------------------------------------#
# # 책 평점별 유사도https://drive.google.com/uc?id=1HbSz-xtR1_PVjg6ZNlfqm47xDbmvIalD
book_similarity_df=pd.read_csv("https://drive.google.com/uc?id=1HbSz-xtR1_PVjg6ZNlfqm47xDbmvIalD",index_col='book_title')
book_ratings_pred_df=pd.read_csv("csv/book_ratings_pred_df.csv",index_col='user_id')
#--------------------------------------------------------------------------------------------------------#
# # 작가 평점별 유사도
author_similarity_df=pd.read_csv("https://drive.google.com/uc?id=15rteykKLX6Lu8O31wmQVKJp9HKEQ67UV",index_col='book_author')
author_ratings_pred_df=pd.read_csv("https://drive.google.com/uc?id=1vq37-PHSlyjCnq68WmdjAagc8-VerYVb",index_col='user_id')
#--------------------------------------------------------------------------------------------------------#
# streamlit 시각화 자료
